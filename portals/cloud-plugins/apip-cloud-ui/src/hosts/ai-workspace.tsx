 ...
 */
// This workspace deploys to AI gateways only, so the page asks the platform for
// those rather than filtering an organization-wide list in the browser.
const AI_GATEWAY_TYPES = ['ai'] as const;
